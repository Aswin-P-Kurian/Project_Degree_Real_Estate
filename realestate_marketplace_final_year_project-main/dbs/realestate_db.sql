...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 22, 2023 at 07:08 AM
...
CREATE TABLE IF NOT EXISTS `home_tbl` (
  ...
  `card_link` varchar(500) NOT NULL DEFAULT '#',
  PRIMARY KEY (`card_id`)
...
ALTER TABLE `city_tbl`
  ADD CONSTRAINT `city_tbl_ibfk_1` FOREIGN KEY (`state_id`) REFERENCES `state_tbl` (`state_id`);
COMMIT;
