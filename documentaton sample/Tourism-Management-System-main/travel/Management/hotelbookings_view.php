...
echo "
<center>
<table class='table table-striped table-bordered table-hover py-5' style='width:200%; border: 4px solid black; text:yellow; text-align: center;'>
<tr class='text-centre text-white'style='font-size:20px; background:grey'>
<th>Booking ID</th>
<th>Hotel Name</th>
<th>Date</th>
<th>Username</th>
